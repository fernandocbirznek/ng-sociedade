...
export class EditarAulaComponent implements OnInit {
  ...
  public reordenarSessoes(): void {
    ...
    this.store.dispatch(atualizarAulaSessaoOrdem({ aulaSessaoMany: this.aulaSessao}));
    //Precisa atualizar na base, pensar se faz um botão para atualizar tudo ou cada vez q reordena
  }
